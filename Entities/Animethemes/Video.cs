...
public class Video
{
    ...
    [Column("nc")] public bool Nc { get; set; }

    [Column("subbed")] public bool Subbed { get; set; }

    [Column("lyrics")] public bool Lyrics { get; set; }

    [Column("uncen")] public bool Uncen { get; set; }

    [Column("overlap")] public int Overlap { get; set; }

    [Column("source")] public int? Source { get; set; }

    [Column("audio_id")] public ulong? AudioId { get; set; }
